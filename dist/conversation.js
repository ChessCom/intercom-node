...
var Conversation = /** @class */ (function () {
    ...
    Conversation.prototype.replyByIdAsUser = function (_a) {
        var id = _a.id, body = _a.body, intercomUserId = _a.intercomUserId, userId = _a.userId, email = _a.email, attachmentUrls = _a.attachmentUrls, attachmentFiles = _a.attachmentFiles;
        var data = {
